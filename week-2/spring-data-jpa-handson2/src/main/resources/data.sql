...
INSERT INTO country (co_code, co_name) VALUES ('KP', 'Democratic Peoples Republic of Korea');
...
-- High Volume Stocks for Facebook
...
-- ==========================================
-- Payroll (Department, Employee, Skill) Seed Data
-- ==========================================
